...
![Schematic Old](../Attachments/Schematic%20Old.png)
Old Schematic

![Schematic New](../Attachments/Schematic%20New.png)
New Schematic

$R_{\text{sense}}$ = 100 Ω (NPN transistor as pass transistor)

$R_{\text{sense}}$ = 100 Ω (MOSFET as pass transistor)

Load Current: 0 - 50 mA

$V_{\text{ref}}$ : 0 - 5 V

$V_{\text{ref}}$ linearly controls the load current
